...
- [personal-copilot project](project_personal-copilot.md) — renamed from shabbat-notifier at the user's request; currently a clean-slate Gateway+Auth+OTel+frontend-login scaffold, after the original Shabbat/WhatsApp feature was stripped back out; stack, architecture, where things live
